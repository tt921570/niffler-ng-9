...
public class UsersQueueExtension implements
    ...
    private final static Queue<StaticUser> NOT_EMPTY_USERS = new ConcurrentLinkedDeque<>();

    static {
        EMPTY_USERS.add(new StaticUser("duck", "12345", true));
        NOT_EMPTY_USERS.add(new StaticUser("goose", "67890", false));
        NOT_EMPTY_USERS.add(new StaticUser("penguin", "54321", false));
    }
